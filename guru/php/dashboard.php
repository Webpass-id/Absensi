    ...
    <div class="container-fluid pt-4 px-4">
      <div class="row g-4">
        <div class="col-sm-6 col-xl-3">
          <div
            class="bg-primary rounded d-flex align-items-center justify-content-between p-4"
          >
        ...
        <div class="col-sm-6 col-xl-3">
          <div
            class="bg-primary rounded d-flex align-items-center justify-content-between py-4 px-5"
          >
        ...
        <div class="col-sm-6 col-xl-3">
          <div
            class="bg-primary rounded d-flex align-items-center justify-content-between p-4 px-5"
          >
            <i class="fa fa-user fa-3x text-white"></i>
            <div class="ms-3">
